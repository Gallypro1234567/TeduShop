    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.NenuGroups", t => t.GroupID, cascadeDelete: true)
                .Index(t => t.GroupID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.OrderID, t.ProductsID })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Menus", "GroupID", "dbo.NenuGroups");
